...
print("Que isso meu filho, calma", end='##') #Por padrão, o windows usa o padrão: CRLF( uma quebra de linha padrão) podemos alterar o comportamento do final do print com o comando end=''
